...
$('.hamburger, .ham-menu-bgg, .hamburger--closee').on('click', function() {
    let bookingClose = $('.hamburger');
    bookingClose.toggleClass('open');
if (bookingClose.hasClass("open")) {
...
$('.booking-btn, .menu_bg, .form-side-close').on('click', function() {
    let bookingClose = $('.nav');
